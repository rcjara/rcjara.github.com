...
This seems like what we want.  Ruby looks like it's protecting you're objects' internal state from other code.  But Ruby also has the instance_variable_set method, which means your objects don't really have any protection at all.
